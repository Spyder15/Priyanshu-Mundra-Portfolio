...
const MiniTerminal = () => {
  ...
  const handleCommand = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === "Enter") {
      ...
      addLine(`guest@priyanshu:~$ ${input}`, "input");
      ...
      switch (cmd) {
        ...
        case "whoami":
          addLine("Priyanshu Mundra | Backend & AI Engineer");
          addLine("LLMs, RAG Pipelines & Scalable Distributed Systems");
          break;

        case "skills":
          addLine("► Python, FastAPI, Node.js, TypeScript, SQL");
          addLine("► LLMs, RAG pipelines, LangChain, AI agents, Pinecone");
          break;

        case "projects":
          addLine("1. AI Customer-Support Chatbot (Award-Winning)");
          addLine("2. PolluxChain + Polink Wallet");
          addLine("3. ZebraSwap DeFi DEX");
          break;
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-black border-4 border-black rounded-2xl shadow-neo overflow-hidden flex flex-col font-mono text-sm sm:text-base">
      <div className="bg-gray-200 border-b-4 border-black px-4 py-2 flex items-center justify-between">
        ...
        <span className="font-bold text-black text-xs tracking-widest">root@priyanshu:~</span>
      ...
      <div className="p-4 h-64 overflow-y-auto bg-black text-custom-blue custom-scrollbar">
        ...
        <div className="flex items-center mt-2">
          <span className="text-custom-green mr-2">guest@priyanshu:~$</span>
          <input
            type="text"
            value={input}
